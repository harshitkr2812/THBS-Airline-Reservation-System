...
<a class="homeadmin" href="admin_rights">Home</a>
</div>
...
<td><form:input path='p_fno'  value='<%=flightno %>'/></td>

<td>From:</td>
<td><form:input path='p_from'  value='<%=from %>'/></td>

<tr><td>To:</td>
<td><form:input path='p_to'  value='<%=to %>'/></td>

<td>Departure Date:</td>
<td><form:input path='p_dedate'  value='<%=dept_date %>'/></td></tr>

<tr><td>Arrival Date:</td>
<td><form:input path='p_ardate'  value='<%=arr_date %>'/></td>

<td>Departure Time:</td>
<td><form:input path='p_detime'  value='<%=dept_time %>'/></td></tr>

<tr><td>Arrival Time:</td>
<td><form:input path='p_artime'  value='<%=arr_time %>'/></td>
...
<td>Age:</td>
<td><form:input type="number" path='p_age'/></td></tr>
...
<td>Class:</td>
				...
				<form:option value="Economy"/> 
					...
					<tr>
<td>Email:</td>
<td><form:input type="email" path='p_email'/></td></tr>
